#!/usr/bin/env python3
"""Download Java Virtual Machine Specification - All Chapters"""
...
def main():
    base_url = "https://docs.oracle.com/javase/specs/jvms/se25/html/"

    # List of chapters to download
    chapters = [
        ('jvms-1.html', 'Chapter 1'),
        ('jvms-2.html', 'Chapter 2'),
        ('jvms-3.html', 'Chapter 3'),
        ('jvms-4.html', 'Chapter 4'),
        ('jvms-5.html', 'Chapter 5'),
        ('jvms-6.html', 'Chapter 6'),
        ('jvms-7.html', 'Chapter 7'),
    ]

    print("Downloading Java SE 25 VM Specification - All Chapters...")
...
<head>
    <meta charset="UTF-8">
    <title>Java Virtual Machine Specification - Java SE 25</title>
    <style>
...
<body>
<h1>Java Virtual Machine Specification</h1>
...
"""
    ...
    # Save to file
    output_file = Path("/tmp/jvms-se25.html")
